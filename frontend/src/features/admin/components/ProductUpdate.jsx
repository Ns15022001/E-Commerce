...
import {
  Button, FormControl, InputLabel, MenuItem, Select, Stack, TextField, Typography, useMediaQuery, useTheme
} from '@mui/material';
    ...
    <Stack p={'0 16px'} justifyContent={'center'} alignItems={'center'} flexDirection={'row'}>
      {
        ...
        <Stack width={is1100 ? "100%" : "60rem"} rowGap={4} mt={is480 ? 4 : 6} mb={6}
          component={'form'} noValidate onSubmit={handleSubmit(handleProductUpdate)}>
          ...
          <Stack rowGap={3}>
            ...
            <Stack flexDirection={'row'} gap={2}>
              ...
              <Stack flex={1}>
                ...
                <TextField type='number' {...register("discountPercentage", { required: "Discount is required" })} />
              </Stack>
            </Stack>
